              ...
              {skillsData.technical.map((skill, index) => (
                ...
                >
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-red-500 text-sm">{skill.level}%</span>
                  </div>
              ...
              {skillsData.soft.map((skill, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-[#141414] border border-white/10 hover:border-red-700/40 transition-all duration-300 text-center group shadow-lg shadow-black/20"
                  >
                    <div className="w-12 h-12 mx-auto rounded-lg bg-red-700/10 flex items-center justify-center mb-3 group-hover:bg-red-700/20 transition-colors">
